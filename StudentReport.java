...
public class StudentReport {
        public static void main(String[] args) {
                ...
                s11.get(1,"Ajay",19321,61,78, 91);
                s21.get(1,"Vikas", 19322, 77,91,65);
                s31.get(1,"Shreya", 19323, 85, 65,87);

                s12.get(2,"Ajay",19321,68,74, 96);
                s22.get(2,"Vikas", 19322, 67,81,75);
                s32.get(2,"Shreya", 19323, 75, 95,77);
